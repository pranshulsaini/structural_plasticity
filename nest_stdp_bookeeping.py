...
class stdp_class:
    ...
    def connections(self):
        ...
        nest.Connect(self.nodes_inp, self.nodes_e, conn_spec = {'rule': 'all_to_all' }, syn_spec = {'model': 'stdp_synapse', 'weight': self.wt_inp_e , 'delay': 1.0, 'tau_plus': 15, 'Wmax':1.})
        ...
        nest.Connect(self.nodes_i, self.nodes_e, conn_spec = {'rule': 'all_to_all'}, syn_spec = {'model': 'stdp_synapse', 'weight': self.wt_i_e , 'delay': 1.0, 'tau_plus': 15, 'Wmax':1.})
    ...
    def plot_data1(self):
        ...
        pl.savefig('stdp_bookeeping_noise.eps', format='eps')
    ...
    def plot_data2(self):
        ...
        pl.savefig('stdp_bookeeping_firingrate.eps', format='eps')
    ...
    def plot_data3(self):
        ...
        pl.savefig('stdp_bookeeping_fittedfiringrate.eps', format='eps')
